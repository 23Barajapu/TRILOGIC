          ...
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="{{ asset('assets/img/service_1.jpg') }}"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="{{ asset('assets/img/service_2.jpg') }}"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="{{ asset('assets/img/service_3.webp') }}"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="{{ asset('assets/img/service_4.jpg') }}"></div>
              </div>
            </div>
          </div>
        </div>
