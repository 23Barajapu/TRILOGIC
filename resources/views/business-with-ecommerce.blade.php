...
@section('content')
          ...
          <div class="cs_main_header_in">
            ...
            <div class="cs_main_header_right">
              <div class="cs_toolbox">
                ...
                <a href="{{ url('shop-cart') }}" class="cs_header_cart">
                  <svg width="24" height="29" viewBox="0 0 24 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_901_441)">
                    <path d="M11.9998 16.2401C10.6009 16.2417 9.24466 15.7788 8.16201 14.9302C7.07938 14.0817 6.33732 12.9 6.0622 11.5863C6.04027 11.4479 6.05001 11.3067 6.09076 11.1722C6.1315 11.0378 6.20227 10.9135 6.29816 10.8079C6.39405 10.7023 6.51277 10.6179 6.64609 10.5605C6.77942 10.5032 6.92415 10.4744 7.07028 10.4759C7.31044 10.4726 7.54395 10.5515 7.72877 10.6984C7.91358 10.8454 8.03756 11.0506 8.07836 11.2774C8.26822 12.1453 8.76417 12.9242 9.48284 13.4832C10.2015 14.0423 11.0991 14.3475 12.025 14.3475C12.9508 14.3475 13.8485 14.0423 14.5672 13.4832C15.2859 12.9242 15.7818 12.1453 15.9717 11.2774C16.0125 11.0506 16.1365 10.8454 16.3213 10.6984C16.5061 10.5515 16.7396 10.4726 16.9798 10.4759C17.1259 10.4744 17.2706 10.5032 17.4039 10.5605C17.5372 10.6179 17.656 10.7023 17.7519 10.8079C17.8478 10.9135 17.9185 11.0378 17.9593 11.1722C18 11.3067 18.0098 11.4479 17.9879 11.5863C17.7111 12.9081 16.9616 14.0962 15.8686 14.9456C14.7755 15.7952 13.4073 16.2529 11.9998 16.2401Z" fill="currentColor"/>
                    <path d="M20.9719 28.9655H3.02804C2.61784 28.966 2.21181 28.8865 1.83468 28.732C1.45754 28.5775 1.11718 28.3511 0.834281 28.0666C0.55138 27.782 0.331868 27.4455 0.189095 27.0771C0.0463218 26.7088 -0.0167275 26.3165 0.00378297 25.9241L0.820332 9.27863C0.854127 8.53239 1.18761 7.82745 1.75115 7.31111C2.31468 6.79475 3.0647 6.50687 3.84458 6.50757H20.1554C20.9353 6.50687 21.6853 6.79475 22.2488 7.31111C22.8124 7.82745 23.1458 8.53239 23.1797 9.27863L23.9962 25.9241C24.0167 26.3165 23.9537 26.7088 23.8109 27.0771C23.6681 27.4455 23.4486 27.782 23.1657 28.0666C22.8828 28.3511 22.5425 28.5775 22.1653 28.732C21.7882 28.8865 21.3822 28.966 20.9719 28.9655ZM3.84458 8.44823C3.57722 8.44823 3.32081 8.55002 3.13177 8.7311C2.94271 8.91209 2.8365 9.15772 2.8365 9.41377L2.01996 26.0207C2.01312 26.1515 2.03413 26.2822 2.08173 26.405C2.12931 26.5278 2.20249 26.64 2.29678 26.7348C2.39109 26.8297 2.50454 26.9051 2.63025 26.9566C2.75597 27.0082 2.8913 27.0347 3.02804 27.0345H20.9719C21.1087 27.0347 21.2441 27.0082 21.3698 26.9566C21.4955 26.9051 21.6089 26.8297 21.7032 26.7348C21.7975 26.64 21.8707 26.5278 21.9183 26.405C21.9659 26.2822 21.9869 26.1515 21.98 26.0207L21.1635 9.37512C21.1635 9.11907 21.0573 8.87352 20.8682 8.69245C20.6791 8.51137 20.4228 8.40966 20.1554 8.40966L3.84458 8.44823Z" fill="currentColor"/>
                    <path d="M18.0482 7.48276H16.032V5.7931C16.032 4.76882 15.6072 3.78649 14.8509 3.06221C14.0948 2.33793 13.0691 1.93103 11.9997 1.93103C10.9303 1.93103 9.90463 2.33793 9.14838 3.06221C8.39221 3.78649 7.96734 4.76882 7.96734 5.7931V7.48276H5.95117V5.7931C5.95117 4.25668 6.58842 2.78318 7.72274 1.69676C8.85707 0.610343 10.3955 0 11.9997 0C13.6039 0 15.1423 0.610343 16.2766 1.69676C17.4109 2.78318 18.0482 4.25668 18.0482 5.7931V7.48276Z" fill="currentColor"/>
                    </g>
                    <defs>
                    <clipPath id="clip0_901_441">
                    <rect width="24" height="28.9655" fill="white"/>
                    </clipPath>
                    </defs>
                  </svg> 
          ...
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                ...
                <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="{{ url('services-details') }}" class="inline-block">Head Shoulder Massage</a></h2>
              </div>
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/pijatabout.jpg"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                ...
                <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="{{ url('services-details') }}" class="inline-block">Back Massage</a></h2>
              </div>
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_2.jpg"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                ...
                <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="{{ url('services-details') }}"  class="inline-block">Foot Massage</a></h2>
              </div>
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_3.webp"></div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-md-6">
            <div class="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
              <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                ...
                <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="{{ url('services-details') }}"  class="inline-block">Lulur/Scrub Full Body</a></h2>
              </div>
              ...
              <div class="cs_service_thumb position-relative cs_rounded_5">
                ...
                <div class="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_4.jpg"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="cs_pb_135 cs_pb_lg_75">
      <div class="container">
        <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_60 cs_mb_lg_40 cs_column_gap_15 cs_row_gap_15 cs_mb_60 cs_mb_lg_40">
          <div class="cs_section_heading_in">
            <h3 class="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Buy Online Products</h3>
            <h2 class="cs_fs_48 cs_fs_lg_36 m-0">Our Latest Products</h2>
          </div>
          <div class="cs_section_heading_right">
            <div class="text-end">
              <a href="{{ url('shop') }}" class="cs_btn cs_style_1 cs_fs_16 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>All Products</span></a>
            </div>
          </div>
        </div>
        <div class="cs_product_slider cs_gap_24">
          <div class="cs_slider_activate">
            <div class="cs_slide">
              <div class="cs_product_card cs_style_1">
                <div class="cs_product_thumb">
                  <img src="assets/img/product_1.jpeg" alt="Product">
                ...
                <div class="cs_product_info">
                  <h2 class="cs_product_title"><a href="{{ url('shop-product-details') }}">Women high shoe</a></h2>
            ...
            <div class="cs_slide">
              <div class="cs_product_card cs_style_1">
                <div class="cs_product_thumb">
                  <img src="assets/img/product_2.jpeg" alt="Product">
                  <div class="cs_product_overlay"></div>
                  <div class="cs_card_btns">
                    <a href="{{ url('shop-cart') }}"><i class="fa-solid fa-cart-plus"></i></a>
                    <a href="{{ url('shop-product-details') }}"><i class="fa-solid fa-link"></i></a>
                ...
                <div class="cs_product_info">
                  <h2 class="cs_product_title"><a href="{{ url('shop-product-details') }}">Wooden top chair</a></h2>
            ...
            <div class="cs_slide">
              <div class="cs_product_card cs_style_1">
                <div class="cs_product_thumb">
                  <img src="assets/img/product_4.jpeg" alt="Product">
                  <div class="cs_product_overlay"></div>
                  <div class="cs_card_btns">
                    <a href="{{ url('shop-cart') }}"><i class="fa-solid fa-cart-plus"></i></a>
                    <a href="{{ url('shop-product-details') }}"><i class="fa-solid fa-link"></i></a>
                ...
                <div class="cs_product_info">
                  <h2 class="cs_product_title"><a href="{{ url('shop-product-details') }}">Nikon dslr camera</a></h2>
            ...
            <div class="cs_slide">
              <div class="cs_product_card cs_style_1">
                <div class="cs_product_thumb">
                  <img src="assets/img/product_5.jpeg" alt="Product">
                  <div class="cs_product_overlay"></div>
                  <div class="cs_card_btns">
                    <a href="{{ url('shop-cart') }}"><i class="fa-solid fa-cart-plus"></i></a>
                    <a href="{{ url('shop-product-details') }}"><i class="fa-solid fa-link"></i></a>
                ...
                <div class="cs_product_info">
                  <h2 class="cs_product_title"><a href="{{ url('shop-product-details') }}">Hemp seed shampoo</a></h2>
    ...
    <!-- End Products -->
    <!-- Offer Section -->
    <section class="cs_offer_section background-filled position-relative" data-src="assets/img/faq_bg_2.jpeg">
      <div class="container">
        <div class="row align-items-center cs_reverse_direction_lg">
          <div class="col-lg-6">
            <img src="assets/img/offer.png" alt="">
          </div>
          <div class="col-lg-6">
            <div class="cs_pt_133 cs_pt_lg_73 cs_pb_140 cs_pb_lg_30">
              <h2 class="cs_fs_48 text-accent cs_mb_8">
                50% Offer
                <svg width="249" height="47" viewBox="0 0 249 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_601_466)">
                  <path d="M2.59294 28.7456C2.59294 28.7456 155.707 7.96482 242.592 18.8052" stroke="#E9A132" stroke-width="5" stroke-linecap="round"/>
                  <path d="M2.81488 25.5361C2.81488 25.5361 159.091 10.8201 245.855 25.909" stroke="#E9A132" stroke-width="5" stroke-linecap="round"/>
                  </g>
                  <defs>
                  <clipPath id="clip0_601_466">
                  <rect width="247.416" height="36.8807" fill="white" transform="translate(0 10.0259) rotate(-2.11611)"/>
                  </clipPath>
                  </defs>
                </svg>                  
              </h2>
              <p class="cs_mb_25">Supercharge Your Online Presence with the Bizmax Theme Exclusive Offer! Instant access to the premium Bizmax Theme at a special discounted rate.</p>
              <div class="cs_countdown cs_style_1 cs_mb_40" data-countdate="2023-12-02T03:45:26">
                <div class="cs_countdown_box bg-white shadow-sm cs_rounded_10">
                  <h3 id="cs_count_days" class="cs_countdown_number cs_fs_36 cs_mb_5"></h3>
                  <div class="cs_countdown_text text-uppercase cs_medium">Days</div>
                </div>
                <div class="cs_countdown_box bg-white shadow-sm cs_rounded_10">
                  <h3 id="cs_count_hours" class="cs_countdown_number cs_fs_36 cs_mb_5"></h3>
                  <div class="cs_countdown_text text-uppercase cs_medium">Hours</div>
                </div>
                <div class="cs_countdown_box bg-white shadow-sm cs_rounded_10">
                  <h3 id="cs_count_minutes" class="cs_countdown_number cs_fs_36 cs_mb_5"></h3>
                  <div class="cs_countdown_text text-uppercase cs_medium">Minutes</div>
                </div>
                <div class="cs_countdown_box bg-white shadow-sm cs_rounded_10">
                  <h3 id="cs_count_seconds" class="cs_countdown_number cs_fs_36 cs_mb_5"></h3>
                  <div class="cs_countdown_text text-uppercase cs_medium">Seconds</div>
                </div>
              </div>
              <a href="{{ url('shop') }}" class="cs_btn cs_style_1 cs_fs_16 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Start Shop Now</span></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Start Team Section -->
    <section class="cs_pt_135 cs_pt_lg_75 cs_pb_115 cs_pb_lg_55">
      <div class="container">
